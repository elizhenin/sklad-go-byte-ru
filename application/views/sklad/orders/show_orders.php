...
<table style="width:100%">
    ...
    <td style="width: 100px"><a title="Не проведен: физически лежит на складе, зарезервирован но не продан, можно освободить и перепродать; Проведен: товар оплачен, вручен клиенту.">?</a></td>
    <td>Дата</td>
    <td>Комментарий</td>
    <td>№ телефона</td>
    <td>Сессия</td>

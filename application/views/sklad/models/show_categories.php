<h1><?php
    if (!empty($alias)) {
        ...
        <form name="form_back" method="GET" style="float:left"
              action="/sklad/categories/<?= substr($alias, 0, strrpos($alias, '/')) ?>">
                ...
                if (!empty($items['categories'])) {
                    foreach ($items['categories'] as $item) {
                        ...
                        <tr>
                            <td>
                                ...
                                <form class="symbols" name="form<?= $item['id'] ?>edit" method="POST"
                                      style="display:inline;float:left;"><input
                                        ...
                                        value="<?= $item['id'] ?>"/><input
                                        type="hidden" name="operation" value="edit"/><input type="submit"
                                                                                            value="&#x270E;"
                                                                                            title="Редактировать" <?= ($rights == 'super') ? '' : 'disabled="disabled"' ?>/>
                                </form>
                                <?php
                                if ($item['deleted']) {
                                    ?>
                                    <form class="symbols" name="form<?= $item['id'] ?>enable" method="POST"
                                        ...
                                        <input
                                            ...
                                            type="hidden" name="operation" value="enable"/><input type="submit"
                                                                                                  value="&#10005;"
                                                                                                  title="Включить" <?= ($rights == 'super') ? '' : 'disabled="disabled"' ?>/>
                                    </form>
                                <?php
                                } else {
                                    ?>
                                    <form class="symbols" name="form<?= $item['id'] ?>disable" method="POST"
                                        ...
                                        <input
                                            ...
                                            type="hidden" name="operation" value="disable"/><input type="submit"
                                                                                                   value="&#10003;"
                                                                                                   title="Отключить" <?= ($rights == 'super') ? '' : 'disabled="disabled"' ?>/>
                                    </form>
                                <?php
                                }
                                ?>
                            ...
                            <td>
                                <a href="/sklad/categories/<?= $alias ?><?= (empty($alias)) ? '' : '/' ?><?= $item['alias'] ?>"><?= $item['name'] ?></a>
                            </td>
                            <td><?= $item['menu'] ?></td>
                            ...
                            <td>
                                ...
                                <form class="symbols" name="form<?= $item['id'] ?>edit" method="POST" style="display:inline;float:left;"
                                      action="/sklad/models"><input
                                        ...
                                        type="hidden" name="operation" value="edit"/><input type="submit"
                                                                                            value="&#x270E;"
                                                                                            title="Редактировать" <?= ($rights != 'sale') ? '' : 'disabled="disabled"' ?>/>
                                </form>
                                <?php
                                if ($item['deleted']) {
                                    ?>
                                    <form class="symbols" name="form<?= $item['id'] ?>enable" method="POST"
                                        ...
                                        <input
                                            ...
                                            type="hidden" name="operation" value="enable"/><input type="submit"
                                                                                                  value="&#10005;"
                                                                                                  title="Включить" <?= ($rights != 'sale') ? '' : 'disabled="disabled"' ?>/>
                                    </form>
                                <?php
                                } else {
                                    ?>
                                    <form class="symbols" name="form<?= $item['id'] ?>disable" method="POST"
                                        ...
                                        <input
                                            ...
                                            type="hidden" name="operation" value="disable"/><input type="submit"
                                                                                                   value="&#10003;"
                                                                                                   title="Отключить" <?= ($rights != 'sale') ? '' : 'disabled="disabled"' ?>/>
                                    </form>
                                <?php
                                }
                                ?>
